...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context 'when the previous step is 8 and the random number is 4' do
      subject(:test_game) { described_class.new(4) }
      it 'returns 4' do
        previous_step = 8
        result = test_game.subtract_random_number(previous_step)
  ...
  describe '#play' do
    context 'when the random number is 4' do
      subject(:with_4) { described_class.new(4) }
    ...
    context 'when the random number is 12' do
      subject(:with_12) { described_class.new(12) }
    ...
    context 'when the random number is 20' do
      subject(:with_20) { described_class.new(20) }
